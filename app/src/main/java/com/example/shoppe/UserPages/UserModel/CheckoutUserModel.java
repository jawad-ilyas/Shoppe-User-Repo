...
public class CheckoutUserModel {
    ...
    public CheckoutUserModel(String productName, String productDescription, String productPrice, String productImage) {
        this.productName = productName;
        this.productDescription = productDescription;
        this.productPrice = productPrice;
        this.productImage = productImage;
    }
    public CheckoutUserModel(String productName, String productDescription, String productPrice,
